...
train_pass_duration_kpi = DurationKpi('train_pass_duration_kpi', 0.03, 0, actived=False)
test_avg_ppl_kpi_card4 = CostKpi('test_avg_ppl_kpi_card4', 0.05, 0, actived=True)
train_pass_duration_kpi_card4 = DurationKpi('train_pass_duration_kpi_card4', 0.03, 0, actived=False)
