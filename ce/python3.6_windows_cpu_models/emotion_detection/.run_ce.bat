...
set ce_mode=1
rem train
python run_classifier.py --use_cuda false --do_train true --do_val true --epoch 50 --lr 0.002 --batch_size 64 --save_checkpoint_dir ./save_models/textcnn --save_steps 2000 --validation_steps 100 --skip_steps 10 > %log_path%/emotion_detection_T.log 2>&1 
