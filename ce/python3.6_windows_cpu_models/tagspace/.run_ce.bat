...
rem train
python train.py --use_cuda 0 --train_dir train_data/ --vocab_text_path vocab_text.txt --vocab_tag_path vocab_tag.txt --model_dir output --batch_size 500 --pass_num 10 > %log_path%\tagsapce_T.log 2>&1
 if not %errorlevel% == 0 (
...
rem infer
python infer.py --use_cuda 0 --model_dir output --vocab_tag_path vocab_tag.txt --test_dir test_data --start_index 1 --last_index 10 > %log_path%\tagsapce_I.log 2>&1
