...
rem train
python run_classifier.py --task_name simnet --use_cuda true --do_train True --do_valid True --do_test True --do_infer False --batch_size 128 --train_data_dir ./lcqmc_data/train.tsv --valid_data_dir ./lcqmc_data/dev.tsv --test_data_dir ./lcqmc_data/test.tsv --infer_data_dir ./lcqmc_data/test.tsv --output_dir ./model_files --config_path  ./config/bow_pointwise.json --vocab_path ./lcqmc_data/term2id.dict --epoch 100 --save_steps 200000 --validation_steps 200 --compute_accuracy False --lamda 0.958 --task_mode pointwise --init_checkpoint ""  > %log_path%/similarity_net_T.log 2>&1
