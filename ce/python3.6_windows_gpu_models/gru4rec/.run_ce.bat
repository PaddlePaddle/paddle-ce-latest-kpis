...
rem train
python train.py --train_dir train_data --use_cuda 1 --batch_size 50 --model_dir output --pass_num 10 > %log_path%/gru4rec_T.log 2>&1
if not %errorlevel% == 0 (
...
python infer.py --test_dir test_data/ --model_dir output --start_index 1 --last_index 10 --use_cuda 1 > %log_path%/gru4rec_I.log 2>&1
