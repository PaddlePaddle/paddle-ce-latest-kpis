...
rem train
python train.py --train_dir train_data --use_cuda 1 --batch_size 50 --model_dir output --epochs 10 > %log_path%/ssr_T.log 2>&1
if not %errorlevel% == 0 (
...
rem infer
python infer.py --test_dir test_data/ --model_dir output --start_index 1 --last_index 10 --use_cuda 1 > %log_path%/ssr_I.log 2>&1
