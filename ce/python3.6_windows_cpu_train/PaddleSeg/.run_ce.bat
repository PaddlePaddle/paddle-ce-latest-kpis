...
rem eval
python pdseg/eval.py --cfg ./configs/deeplabv3p_xception65_optic.yaml > %log_path%/deeplabv3p_xception65_E.log 2>&1
if not %errorlevel% == 0 (
...
python pdseg/train.py --enable_ce --cfg ./configs/icnet_optic.yaml | grep "epoch"| gawk  -F "[= ]" "{if ($4 >=60) print \"kpis\ticnet_loss_card1\t\"$8\"\nkpis\ticnet_speed_card1\t\"$10}" | python _ce.py
rem eval
python pdseg/eval.py --cfg ./configs/icnet_optic.yaml > %log_path%/icnet_E.log 2>&1
if not %errorlevel% == 0 (
...
python pdseg/train.py --enable_ce --cfg ./configs/unet_optic.yaml | grep "epoch"| gawk  -F "[= ]" "{if ($4 >=60) print \"kpis\tunet_loss_card1\t\"$8\"\nkpis\tunet_speed_card1\t\"$10}" | python _ce.py
rem eval
python pdseg/eval.py --cfg ./configs/unet_optic.yaml > %log_path%/unet_E.log 2>&1
if not %errorlevel% == 0 (
...
python pdseg/train.py --enable_ce --cfg ./configs/pspnet_optic.yaml | grep "epoch"| gawk  -F "[= ]" "{if ($4 >=60) print \"kpis\tpspnet_loss_card1\t\"$8\"\nkpis\tpspnet_speed_card1\t\"$10}" | python _ce.py
rem eval
python pdseg/eval.py --cfg ./configs/unet_optic.yaml > %log_path%/pspnet_E.log 2>&1
if not %errorlevel% == 0 (
