...
rem infer
python infer.py --vocab_size 10003 --batch_size 32  --init_scale 0.1  --max_grad_norm 5.0 --dataset_prefix data/ptb/ptb --use_gpu False  --reload_model ptb_model/epoch_0 > %log_path%/variational_seq2seq_ptb_I.log 2>&1
if not %errorlevel% == 0 (
