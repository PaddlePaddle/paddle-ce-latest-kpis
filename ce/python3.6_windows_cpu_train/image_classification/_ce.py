...
AlexNet_loss_card1_kpi = CostKpi('AlexNet_loss_card1', 0.1, 0, actived=True, desc='train cost')
...
DPN107_loss_card1_kpi = CostKpi('DPN107_loss_card1', 0.1, 0, actived=True, desc='train cost')
...
DarkNet53_loss_card1_kpi = CostKpi('DarkNet53_loss_card1', 0.1, 0, actived=True, desc='train cost')
...
DenseNet121_loss_card1_kpi = CostKpi('DenseNet121_loss_card1', 0.1, 0, actived=True, desc='train cost')
...
EfficientNet_loss_card1_kpi = CostKpi('EfficientNet_loss_card1', 0.1, 0, actived=True, desc='train cost')
...
GoogLeNet_loss_card1_kpi = CostKpi('GoogLeNet_loss_card1', 0.1, 0, actived=True, desc='train cost')
...
HRNet_W18_C_loss_card1_kpi = CostKpi('HRNet_W18_C_loss_card1', 0.1, 0, actived=True, desc='train cost')
...
InceptionV4_loss_card1_kpi = CostKpi('InceptionV4_loss_card1', 0.1, 0, actived=True, desc='train cost')
...
MobileNetV1_loss_card1_kpi = CostKpi('MobileNetV1_loss_card1', 0.1, 0, actived=True, desc='train cost')
...
MobileNetV2_loss_card1_kpi = CostKpi('MobileNetV2_loss_card1', 0.1, 0, actived=True, desc='train cost')
...
Res2Net50_vd_26w_4s_loss_card1_kpi = CostKpi('Res2Net50_vd_26w_4s_loss_card1', 0.1, 0, actived=True, desc='train cost')
...
ResNeXt101_32x4d_loss_card1_kpi = CostKpi('ResNeXt101_32x4d_loss_card1', 0.1, 0, actived=True, desc='train cost')
...
ResNet152_vd_loss_card1_kpi = CostKpi('ResNet152_vd_loss_card1', 0.1, 0, actived=True, desc='train cost')
...
SE_ResNeXt50_vd_32x4d_loss_card1_kpi = CostKpi('SE_ResNeXt50_vd_32x4d_loss_card1', 0.1, 0, actived=True, desc='train cost')
...
ShuffleNetV2_swish_loss_card1_kpi = CostKpi('ShuffleNetV2_swish_loss_card1', 0.1, 0, actived=True, desc='train cost')
...
SqueezeNet1_1_loss_card1_kpi = CostKpi('SqueezeNet1_1_loss_card1', 0.1, 0, actived=True, desc='train cost')
...
VGG19_loss_card1_kpi = CostKpi('VGG19_loss_card1', 0.1, 0, actived=True, desc='train cost')
...
Xception65_deeplab_loss_card1_kpi = CostKpi('Xception65_deeplab_loss_card1', 0.1, 0, actived=True, desc='train cost')
...
ResNet50_loss_card1_kpi = CostKpi('ResNet50_loss_card1', 0.1, 0, actived=True, desc='train cost')
...
ResNeXt101_32x8d_wsl_loss_card1_kpi = CostKpi('ResNeXt101_32x8d_wsl_loss_card1', 0.1, 0, actived=True, desc='train cost')
