...
rem infer
python run_classifier.py --use_cuda false --do_infer true --batch_size 32 --init_checkpoint ./save_models/textcnn/step_1510  > %log_path%/emotion_detection_I.log 2>&1
if not %errorlevel% == 0 (
