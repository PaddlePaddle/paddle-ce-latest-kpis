...
rem eval
python eval.py --model=crnn_ctc --model_path=output_ctc/model_00010 --use_gpu False > %log_path%/ocr_ctc_E.log
if not %errorlevel% == 0 (
...
rem infer
python iner.py --model=crnn_ctc --model_path=output_ctc/model_00010 --use_gpu False > %log_path%/ocr_ctc_I.log
if not %errorlevel% == 0 (
