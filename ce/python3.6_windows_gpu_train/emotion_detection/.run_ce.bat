...
rem eval
python run_classifier.py --use_cuda true --do_val true --batch_size 128  --init_checkpoint ./save_models/textcnn/step_756 > %log_path%/emotion_detection_E.log 2>&1
if not %errorlevel% == 0 (
...
rem infer
python run_classifier.py  --do_infer true --batch_size 32 --init_checkpoint ./save_models/textcnn/step_756  > %log_path%/emotion_detection_I.log 2>&1
if not %errorlevel% == 0 (
...
python inference_model.py --use_cuda true --do_save_inference_model true --init_checkpoint ./save_models/textcnn/step_756 --inference_model_dir ./inference_model > %log_path%/emotion_detection_save_infer.log 2>&1
if not %errorlevel% == 0 (
