...
rem infer
python infer.py --init_model output_pix2pix/checkpoints/0/ --image_size 256 --dataset_dir "data/cityscapes/testB/*" --model_net Pix2pix --net_G unet_256 --use_gpu true > %log_path%/pix2pix_I.log 2>&1
if not %errorlevel% == 0 (
