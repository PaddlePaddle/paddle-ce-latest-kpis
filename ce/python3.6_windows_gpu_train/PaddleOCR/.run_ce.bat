...
rem det_mv3_db
python tools/train.py -c configs/det/det_mv3_db.yml -o Global.use_gpu=True Global.epoch_num=1 Global.save_epoch_step=1 Global.eval_batch_step=60 > %log_path%/det_mv3_db_T.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/eval.py -c configs/det/det_mv3_db.yml  -o Global.use_gpu=True Global.checkpoints="output/det_db/best_accuracy" > %log_path%/det_mv3_db_E.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/infer_det.py -c configs/det/det_mv3_db.yml -o Global.use_gpu=True TestReader.infer_img="./doc/imgs_en/" Global.checkpoints="output/det_db/best_accuracy" > %log_path%/det_mv3_db_I.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/export_model.py -c configs/det/det_mv3_db.yml -o Global.use_gpu=True Global.checkpoints="output/det_db/best_accuracy" Global.save_inference_dir="./inference_det/det_db" > %log_path%/det_mv3_db_export.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/infer/predict_det.py --image_dir="./doc/imgs_en/img_10.jpg" --det_model_dir="./inference_det/det_db" --det_algorithm=DB --use_gpu=True --use_tensorrt=True > %log_path%/det_mv3_db_P.log 2>&1
if %errorlevel% GTR 0 (
...
rem det_r50_vd_east
python tools/train.py -c configs/det/det_r50_vd_east.yml -o Global.use_gpu=True Global.epoch_num=1 Global.save_epoch_step=1 Global.eval_batch_step=60 > %log_path%/det_r50_vd_east_T.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/eval.py -c configs/det/det_r50_vd_east.yml  -o Global.use_gpu=True Global.checkpoints="output/det_east/best_accuracy" > %log_path%/det_r50_vd_east_E.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/infer_det.py -c configs/det/det_r50_vd_east.yml -o Global.use_gpu=True TestReader.infer_img="./doc/imgs_en/" Global.checkpoints="output/det_east/best_accuracy" > %log_path%/det_r50_vd_east_I.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/export_model.py -c configs/det/det_r50_vd_east.yml -o Global.use_gpu=True Global.checkpoints="output/det_east/best_accuracy" Global.save_inference_dir="./inference_det/det_east" > %log_path%/det_r50_vd_east_export.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/infer/predict_det.py --image_dir="./doc/imgs_en/img_10.jpg" --det_model_dir="./inference_det/det_east" --det_algorithm=EAST --use_gpu=True --use_tensorrt=True > %log_path%/det_r50_vd_east_P.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/train.py -c configs/rec/rec_icdar15_train.yml -o Global.use_gpu=True Global.epoch_num=1 Global.save_epoch_step=1 Global.eval_batch_step=10 Global.print_batch_step=10 > %log_path%/rec_icdar15_train_T.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/eval.py -c configs/rec/rec_icdar15_train.yml  -o Global.use_gpu=True Global.checkpoints="output/rec_CRNN/best_accuracy" > %log_path%/rec_icdar15_train_E.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/infer_rec.py -c configs/rec/rec_icdar15_train.yml  -o Global.use_gpu=True Global.checkpoints="output/rec_CRNN/best_accuracy" TestReader.infer_img=doc/imgs_words/en/word_1.png > %log_path%/rec_icdar15_train_I.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/export_model.py -c configs/rec/rec_icdar15_train.yml -o Global.use_gpu=True  Global.checkpoints="output/rec_CRNN/best_accuracy" Global.save_inference_dir=./inference_rec/rec_CRNN > %log_path%/rec_icdar15_train_export.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/infer/predict_rec.py --image_dir="./doc/imgs_words_en/word_336.png" --rec_model_dir=./inference_rec/rec_CRNN --rec_image_shape="3, 32, 100" --rec_char_type="en" --use_gpu=True --use_tensorrt=True > %log_path%/rec_icdar15_train_P.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/train.py -c configs/rec/rec_chinese_lite_train.yml -o Global.use_gpu=True Global.epoch_num=1 Global.save_epoch_step=1 Global.eval_batch_step=10 Global.print_batch_step=10 > %log_path%/rec_chinese_lite_train_T.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/eval.py -c configs/rec/rec_chinese_lite_train.yml  -o Global.use_gpu=True Global.checkpoints="output/rec_CRNN/best_accuracy" > %log_path%/rec_chinese_lite_train_E.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/infer_rec.py -c configs/rec/rec_chinese_lite_train.yml  -o Global.use_gpu=True Global.checkpoints="output/rec_CRNN/best_accuracy" TestReader.infer_img=doc/imgs_words/en/word_1.png > %log_path%/rec_chinese_lite_train_I.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/export_model.py -c configs/rec/rec_chinese_lite_train.yml -o Global.use_gpu=True  Global.checkpoints="output/rec_CRNN/best_accuracy" Global.save_inference_dir=./inference_rec/rec_CRNN > %log_path%/rec_chinese_lite_train_export.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/infer/predict_rec.py --image_dir="./doc/imgs_words_en/word_336.png" --rec_model_dir=./inference_rec/rec_CRNN --rec_image_shape="3, 32, 100" --rec_char_type="en" --use_gpu=True --use_tensorrt=True > %log_path%/rec_chinese_lite_train_P.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/train.py -c configs/rec/rec_r34_vd_none_none_ctc.yml -o Global.use_gpu=True Global.epoch_num=1 Global.save_epoch_step=1 Global.eval_batch_step=10 Global.print_batch_step=10 > %log_path%/rec_r34_vd_none_none_ctc_T.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/eval.py -c configs/rec/rec_r34_vd_none_none_ctc.yml  -o Global.use_gpu=True Global.checkpoints="output/rec_Rosetta/best_accuracy" > %log_path%/rec_r34_vd_none_none_ctc_E.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/infer_rec.py -c configs/rec/rec_r34_vd_none_none_ctc.yml  -o Global.use_gpu=True Global.checkpoints="output/rec_Rosetta/best_accuracy" TestReader.infer_img=doc/imgs_words/en/word_1.png > %log_path%/rec_r34_vd_none_none_ctc_I.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/export_model.py -c configs/rec/rec_r34_vd_none_none_ctc.yml -o Global.use_gpu=True  Global.checkpoints="output/rec_Rosetta/best_accuracy" Global.save_inference_dir=./inference_rec/rec_Rosetta > %log_path%/rec_r34_vd_none_none_ctc_export.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/infer/predict_rec.py --image_dir="./doc/imgs_words_en/word_336.png" --rec_model_dir=./inference_rec/rec_Rosetta --rec_image_shape="3, 32, 100" --rec_char_type="en" --use_gpu=True --use_tensorrt=True > %log_path%/rec_r34_vd_none_none_ctc_P.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/train.py -c configs/rec/rec_mv3_tps_bilstm_ctc.yml -o Global.use_gpu=True Global.epoch_num=1 Global.save_epoch_step=1 Global.eval_batch_step=10 Global.print_batch_step=10 > %log_path%/rec_mv3_tps_bilstm_ctc_T.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/eval.py -c configs/rec/rec_mv3_tps_bilstm_ctc.yml  -o Global.use_gpu=True Global.checkpoints="output/rec_STARNet/best_accuracy" > %log_path%/rec_mv3_tps_bilstm_ctc_E.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/infer_rec.py -c configs/rec/rec_mv3_tps_bilstm_ctc.yml  -o Global.use_gpu=True Global.checkpoints="output/rec_STARNet/best_accuracy" TestReader.infer_img=doc/imgs_words/en/word_1.png > %log_path%/rec_mv3_tps_bilstm_ctc_I.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/export_model.py -c configs/rec/rec_mv3_tps_bilstm_ctc.yml -o Global.use_gpu=True  Global.checkpoints="output/rec_STARNet/best_accuracy" Global.save_inference_dir=./inference_rec/rec_STARNet > %log_path%/rec_mv3_tps_bilstm_ctc_export.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/infer/predict_rec.py --image_dir="./doc/imgs_words_en/word_336.png" --rec_model_dir=./inference_rec/rec_STARNet --rec_image_shape="3, 32, 100" --rec_char_type="en" --use_gpu=True --use_tensorrt=True > %log_path%/rec_mv3_tps_bilstm_ctc_P.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/train.py -c configs/rec/rec_mv3_tps_bilstm_attn.yml -o Global.use_gpu=True Global.epoch_num=1 Global.save_epoch_step=1 Global.eval_batch_step=10 Global.print_batch_step=10 > %log_path%/rec_mv3_tps_bilstm_attn_T.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/eval.py -c configs/rec/rec_mv3_tps_bilstm_attn.yml  -o Global.use_gpu=True Global.checkpoints="output/rec_RARE/best_accuracy" > %log_path%/rec_mv3_tps_bilstm_attn_E.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/infer_rec.py -c configs/rec/rec_mv3_tps_bilstm_attn.yml  -o Global.use_gpu=True Global.checkpoints="output/rec_RARE/best_accuracy" TestReader.infer_img=doc/imgs_words/en/word_1.png > %log_path%/rec_mv3_tps_bilstm_attn_I.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/export_model.py -c configs/rec/rec_mv3_tps_bilstm_attn.yml -o Global.use_gpu=True  Global.checkpoints="output/rec_RARE/best_accuracy" Global.save_inference_dir=./inference_rec/rec_RARE > %log_path%/rec_mv3_tps_bilstm_attn_export.log 2>&1
if %errorlevel% GTR 0 (
...
python tools/infer/predict_rec.py --image_dir="./doc/imgs_words_en/word_336.png" --rec_model_dir=./inference_rec/rec_RARE --rec_image_shape="3, 32, 100" --rec_char_type="en" --use_gpu=True --use_tensorrt=True > %log_path%/rec_mv3_tps_bilstm_attn_P.log 2>&1
if %errorlevel% GTR 0 (
