...
rem infer 
python infer.py --init_model output_cyclegan/checkpoints/0/ --dataset_dir "data/cityscapes/testB/*" --image_size 256 --input_style B --model_net CycleGAN --net_G resnet_9block  --g_base_dims 32 --use_gpu true > %log_path%/cyclgan_I.log 2>&1
if not %errorlevel% == 0 (
