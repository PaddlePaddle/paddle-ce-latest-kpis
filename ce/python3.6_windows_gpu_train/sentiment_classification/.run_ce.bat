...
python -u run_classifier.py  --task_name senta --use_cuda true --do_train true --do_val true --do_infer false --batch_size 16 --data_dir ./senta_data/ --vocab_path ./senta_data//word_dict.txt --checkpoints ./save_models --save_steps 500 --validation_steps 50 --epoch 1 --senta_config_path ./senta_config.json --skip_steps 10 --random_seed 0 --enable_ce True > sentiment_classification.log 2>&1
