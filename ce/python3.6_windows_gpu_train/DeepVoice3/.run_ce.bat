...
python synthesis.py --config=configs/ljspeech.yaml --device=0 experiment/checkpoints/model_step_005000000 sentences.txt generated > %log_path%/deepvoice3_synthesis.log
if not %errorlevel% == 0 (
