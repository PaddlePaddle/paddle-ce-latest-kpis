...
%sed% -i s/"  max_iteration: 2000000"/"  max_iteration: 6"/g configs/ljspeech.yaml
%sed% -i s/"  snap_interval: 1000"/"  snap_interval: 3"/g configs/ljspeech.yaml
%sed% -i s/"  eval_interval: 10000"/"  eval_interval: 3"/g configs/ljspeech.yaml
