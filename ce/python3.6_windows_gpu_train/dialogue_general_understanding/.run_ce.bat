...
rem evaluate
python -u main.py --task_name atis_intent --use_cuda true --do_eval=true --evaluation_file=./data/input/data/atis/atis_intent/test.txt --output_prediction_file=./data/output/pred_atis_intent
if not %errorlevel% == 0 (
