...
each_epoch_duration_frame4_card1 = DurationKpi("each_epoch_duration_frame4_card1", 0.1, 0, actived=True)
train_cost_frame4_card1 = CostKpi("train_cost_frame4_card1", 0.1, 0, actived=True)
