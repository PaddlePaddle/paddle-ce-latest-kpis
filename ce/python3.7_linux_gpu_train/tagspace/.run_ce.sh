...
#infer
python infer.py --model_dir big_model --vocab_tag_path vocab_tag.txt --test_dir test_data/ --start_index 1 --last_index 1 >infer
if [ $? -ne 0 ];then
	echo -e "tagspace,infer,FAIL"
else
	echo -e "tagspace,infer,SUCCESS"
fi
