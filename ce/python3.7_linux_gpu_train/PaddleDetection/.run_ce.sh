...
python tools/train.py -c configs/cascade_rcnn_r50_fpn_1x.yml --enable_ce=True -o max_iters=1000 FasterRCNNTrainFeed.shuffle=false | python _ce.py
...
python tools/train.py -c configs/mask_rcnn_r50_fpn_1x.yml --enable_ce=True -o max_iters=1000 MaskRCNNTrainFeed.shuffle=false | python _ce.py
