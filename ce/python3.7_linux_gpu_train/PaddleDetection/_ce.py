...
tracking_kpis = [CascadeRCNN_train_loss_kpi, CascadeRCNN_train_time_kpi, FasterRCNN_train_loss_kpi, FasterRCNN_train_time_kpi, MaskRCNN_train_loss_kpi, MaskRCNN_train_time_kpi, YOLOv3_train_loss_kpi, YOLOv3_train_time_kpi]
