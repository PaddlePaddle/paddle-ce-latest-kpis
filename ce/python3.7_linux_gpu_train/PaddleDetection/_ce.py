...
tracking_kpis = [FasterRCNN_train_loss_kpi, FasterRCNN_train_time_kpi, 
                 MaskRCNN_train_loss_kpi, MaskRCNN_train_time_kpi, 
                 YOLOv3_train_loss_kpi, YOLOv3_train_time_kpi]
