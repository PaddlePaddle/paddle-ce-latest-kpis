...
each_step_duration_simnet_card1 = DurationKpi('each_step_duration_simnet_card1', 0.04, 0, actived=True)
train_loss_simnet_card1 = CostKpi('train_loss_simnet_card1', 0.01, 0, actived=True)
each_step_duration_simnet_card4 = DurationKpi('each_step_duration_simnet_card4', 0.04, 0, actived=True)
