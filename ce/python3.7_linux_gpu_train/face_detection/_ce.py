...
train_face_loss_card1_kpi = CostKpi('train_face_loss_card1', 0.3, 0, actived=True)
...
train_face_loss_card4_kpi = CostKpi('train_face_loss_card4', 0.5, 0, actived=True)
train_head_loss_card4_kpi = CostKpi('train_head_loss_card4', 0.3, 0, actived=True)
