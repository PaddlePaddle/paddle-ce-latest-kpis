...
#infer
python widerface_eval.py --infer=True --confs_threshold=0.15 --model_dir=output/0/ --image_path=data/WIDER_train/images/0--Parade/0_Parade_marchingband_1_219.jpg >infer
if [ $? -ne 0 ];then
