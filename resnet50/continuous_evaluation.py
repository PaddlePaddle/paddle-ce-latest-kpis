...
cifar10_gpu_memory_kpi = DurationKpi('cifar10_gpu_memory', 0.02, 0, actived=True)
flowers_train_speed_kpi = AccKpi('flowers_train_speed', 0.02, 0, actived=True)
flowers_gpu_memory_kpi = DurationKpi('flowers_gpu_memory', 0.02, 0, actived=True)
...
cifar10_gpu_memory_kpi_card4 = DurationKpi('cifar10_gpu_memory_card4', 0.02, 0, actived=True)
flowers_train_speed_kpi_card4 = AccKpi('flowers_train_speed_card4', 0.02, 0, actived=True)
flowers_gpu_memory_kpi_card4 = DurationKpi('flowers_gpu_memory_card4', 0.02, 0, actived=True)
