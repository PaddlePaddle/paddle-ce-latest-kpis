...
if [[ $3 == 'chnsenticorp' ]];then #GPU/cpu
    python bert_distill.py \
        ...
        --teacher_path small_models/chnsenticorp/step_150.pdparams \
    ...
    python bert_distill.py \
        ...
        --teacher_path small_models/SST-2/step_990.pdparams \
        --save_steps 1000 \
        --device ${DEVICE} \
    ...
    python bert_distill.py \
        ...
        --teacher_path small_models/QQP/step_1200.pdparams \
        --save_steps 1000 \
        --device ${DEVICE} \
        --embedding_name w2v.google_news.target.word-word.dim300.en >$log_path/distill_$3_$2_${DEVICE}.log 2>&1
    print_info $? distill_$3_$2_${DEVICE}
