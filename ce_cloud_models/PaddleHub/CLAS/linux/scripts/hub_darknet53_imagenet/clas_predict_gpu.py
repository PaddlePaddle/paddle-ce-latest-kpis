...
expect = [[{
    'ringneck snake': 0.0015541635220870376
}], [{
    'ringneck snake': 0.0015288941795006394
}]]

assert np.allclose(
    np.array(result[0][0]['ringneck snake']),
    np.array(expect[0][0]['ringneck snake']))
assert np.allclose(
    np.array(result[1][0]['ringneck snake']),
    np.array(expect[1][0]['ringneck snake']))
# print(result)
