...
cifar10_128_AllReduce_GPU_4_Cards_train_speed_kpi = AccKpi(
    'cifar10_128_AllReduce_GPU_4_Cards_train_speed', 0.20, 0, actived=True)
...
cifar10_128_Reduce_GPU_4_Cards_train_speed_kpi = AccKpi(
    'cifar10_128_Reduce_GPU_4_Cards_train_speed', 0.20, 0, actived=True)
...
cifar10_128_GPU_1_Cards_train_speed_kpi = AccKpi(
    'cifar10_128_GPU_1_Cards_train_speed', 0.10, 0, actived=True)
...
flowers_64_AllReduce_GPU_4_Cards_train_speed_kpi = AccKpi(
    'flowers_64_AllReduce_GPU_4_Cards_train_speed', 0.20, 0, actived=True)
...
flowers_64_Reduce_GPU_4_Cards_train_speed_kpi = AccKpi(
    'flowers_64_Reduce_GPU_4_Cards_train_speed', 0.20, 0, actived=True)
