...
flowers_64_AllReduce_GPU_4_Cards_train_acc_kpi = AccKpi(
    'flowers_64_AllReduce_GPU_4_Cards_train_acc', 0.06, 0, actived=False)
...
flowers_64_Reduce_GPU_4_Cards_train_acc_kpi = AccKpi(
    'flowers_64_Reduce_GPU_4_Cards_train_acc', 0.07, 0, actived=True)
...
flowers_64_GPU_1_Cards_train_acc_kpi = AccKpi(
    'flowers_64_GPU_1_Cards_train_acc', 0.07, 0, actived=False)
