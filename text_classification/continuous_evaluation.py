...
lstm_pass_duration_kpi = DurationKpi(
    'lstm_pass_duration', 0.03, 0, actived=False)

lstm_train_cost_kpi_card4 = CostKpi('lstm_train_cost_card4', 0.2, 0)
lstm_pass_duration_kpi_card4 = DurationKpi(
    'lstm_pass_duration_card4', 0.02, 0, actived=True)
