...
cifar10_8_AllReduce_CPU_4_Cards_train_acc_kpi = AccKpi(
    'cifar10_8_AllReduce_CPU_4_Cards_train_acc', 0.02, 0, actived=True)
...
cifar10_8_Reduce_CPU_4_Cards_train_acc_kpi = AccKpi(
    'cifar10_8_Reduce_CPU_4_Cards_train_acc', 0.02, 0, actived=True)
...
cifar10_8_CPU_1_Cards_train_acc_kpi = AccKpi(
    'cifar10_8_CPU_1_Cards_train_acc', 0.02, 0, actived=True)
...
flowers_8_AllReduce_CPU_4_Cards_train_acc_kpi = AccKpi(
    'flowers_8_AllReduce_CPU_4_Cards_train_acc', 0.02, 0, actived=True)
...
flowers_8_Reduce_CPU_4_Cards_train_acc_kpi = AccKpi(
    'flowers_8_Reduce_CPU_4_Cards_train_acc', 0.02, 0, actived=True)
...
flowers_8_CPU_1_Cards_train_acc_kpi = AccKpi(
    'flowers_8_CPU_1_Cards_train_acc', 0.02, 0, actived=True)
